...
int main() {
    ...
    do {
        ...
        sendto(sock, &choice, sizeof(choice), 0, (struct sockaddr *)&serv_addr, sizeof(serv_addr));

        char buffer[MAX_BUFFER_SIZE] = {0};
        recvfrom(sock, buffer, MAX_BUFFER_SIZE, 0, NULL, NULL);
        printf("Result: %s\n", buffer);
        ...
        sendto(sock, play_response, strlen(play_response), 0, (struct sockaddr *)&serv_addr, sizeof(serv_addr));
        recvfrom(sock, &flag, sizeof(flag), 0, NULL, NULL);
